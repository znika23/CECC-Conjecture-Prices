...
class Edge_Server:
    DEFAULTS = {
        "D": [200, 400, 600, 800],  # Resource demand (kG CPU cycles)
        "A_u": [0, 100, 200, 300, 400, 500, 600],  # Purchase amount of universal resource (kG CPU cycles)
        "A_d": [0, 100, 200, 300, 400],  # Purchase amount of dynamic resource (kG CPU cycles)
        "f_u": 100,  # Hourly frequency of cloud universal resource (kG CPU cycles/h)
        "f_d": 100,  # Hourly frequency of cloud dynamic resource (kG CPU cycles/h)
        "f_l": 50,  # Hourly frequency of local resource (kG CPU cycles/h)
        "ρ_l": 3.0,  # Hourly price of edge's local resource (RMB)
        "p_max": 400,  # Maximum amount of excess purchased universal resource
        "t_avg": 0.15,  # Average CPU cycles of tasks
        "l": 0.04  # Average transmission latency of tasks
    }
