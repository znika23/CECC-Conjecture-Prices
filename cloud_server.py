...
class Cloud_Server:
    DEFAULTS = {
        ...
        "f_u": 100,  # Hourly frequency of universal resource (10^12 CPU cycles/h)
        "ρ_d": 0.5,  # Hourly price of dynamic resource (RMB)
        "f_d": 100,  # Hourly frequency of dynamic resource (10^12 CPU cycles/h)
        "U": [0, 800, 1600],  # Distribution of hourly available dynamic resource (10^12 CPU cycles)
